        ...
        <>
            ...
            <div class="bg-white">
                <div class="px-4 pb-16 pt-14 mx-auto sm:max-w-xl md:max-w-full lg:max-w-7xl md:px-24 lg:px-8">
                    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                        <p
                            class="inline-block px-3 py-px mb-2 text-base font-semibold tracking-wider w-full text-gray-600 uppercase secondary_text editable">
                            Ak - Ideal Hotel</p>
                        <h2 class="max-w-lg mb-5 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto primary_text editable"
                            data-content="website-headlines">Get The Best Deals On Hotels Worldwide With Ak-Ideal Hotel</h2>
                        <p class="text-base text-gray-700 md:text-lg secondary_text editable"
                    ...
                    <div class="grid max-w-screen-lg gap-8 row-gap-5 mb-8 sm:grid-cols-2 lg:grid-cols-4 sm:mx-auto">
                        <div class="relative"><img class="object-cover w-full h-56 rounded shadow-lg img-editable"
                        ...
                        <div class="relative max-md:hidden"><img class="object-cover w-full h-56 rounded shadow-lg img-editable"
                    ...
                    <div class="flex items-center sm:justify-center">
                        <a href="#"
                            class="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-gray-600 hover:bg-gray-700 focus:shadow-outline focus:outline-none secondary_text btn-editable editable">Sign
                            up</a>
                        <a href="#" aria-label=""
                            class="inline-flex items-center font-semibold transition-colors duration-200 text-gray-900 hover:text-gray-800 secondary_text link-editable editable">Learn
                            more</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex flex-wrap items-center sm:-mx-3">
                        <div class="w-full md:w-1/2 md:px-3">
                            <div
                                ...
                                <h1 class="text-5xl font-extrabold text-black primary_text editable"
                                    data-content="website-headlines">Get the Perfect Hotel for Your Trip with Ak-Ideal Hotels!
                                </h1>
                                <p class="mx-auto text-xl text-gray-600 secondary_text editable"
                                ...
                                <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                                    <a href="#_"
                                        class="inline-flex items-center justify-center h-12 px-6 mr-1 font-medium transition duration-200 rounded shadow-md primary_button_background bg-gray-600 text-white primary_button_text focus:shadow-outline focus:outline-none btn-editable">
                                        Try It Free
                                    ...
                                    <a href="#_"
                                        class="flex items-center h-12 px-6 py-3 rounded-md text-gray-600 bg-gray-100 btn-editable">
                                        Learn More
                                    </a>
                                </div>
                            </div>
            ...
            <div class="bg-white">
                <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20"
                    ...
                    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                        <div>
                            <p
                                class="inline-block mb-2 text-base font-semibold tracking-wider text-gray-600 uppercase rounded-full secondary_text editable">
                                How it works</p>
                        </div>
                        <h2 class="max-w-lg mb-6 text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto primary_text editable"
                            data-content="website-headlines">Secure Your Hotel Bookings With Ak-Ideal and Enjoy Special Offers!
                        </h2>
                        <p class="text-base text-gray-600 md:text-lg secondary_text editable"
                    ...
                    <div class="grid gap-8 row-gap-0 lg:grid-cols-3">
                        <div class="relative text-center" data-subcontent="step_1">
                            ...
                            <h6 class="mb-2 text-2xl text-gray-900 font-extrabold primary_text editable"
                                data-subcontent="step-title">Step 1</h6>
                            <p class="max-w-md mb-3 text-sm text-gray-600 sm:mx-auto secondary_text editable"
            ...
            <div class="bg-white body-font">
                <div class="container px-5 py-24 mx-auto">
                    <div class="text-center mb-20">
                        <h1 class="sm:text-4xl text-3xl font-bold text-center title-font text-gray-900 mb-4 primary_text editable"
                            data-content="website-headlines">Find Your Ideal Hotel and Enjoy Special Offers On Your Bookings
                        </h1>
                        <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-600 secondary_text editable"
                    ...
                    <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                        <div class="p-2 sm:w-1/2 w-full" data-content="features">
                            <div class="bg-gray-50 rounded flex p-4 h-full items-center">
                                ...
                                <p class="title-font text-gray-600 font-medium w-full secondary_text editable"
            ...
            <div class="py-20 bg-white">
                <div class="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
                    <h2 class="text-5xl font-extrabold tracking-tight text-gray-900 sm:text-4xl primary_text editable"
                        data-content="cta">Book from world wide hotels</h2>
                    <p class="max-w-md mx-auto mt-3 text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl secondary_text editable"
                    ...
                    <div class="flex justify-center mt-8 space-x-3">
                        <a href="#"
                            class="inline-flex items-center justify-center px-5 py-3 text-base font-semibold text-white bg-gray-600 rounded-md shadow hover:bg-gray-700 btn-editable">Sign
                            Up Today</a>
                        <a href="#"
                            class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-gray-600 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600 btn-editable">Learn
                            more</a>
                    </div>
                </div>
            </div>
